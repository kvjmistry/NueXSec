...
if [ -z "$1" ]; then
  ...
  mc="./nuexsec --run 3 --mc /uboone/data/users/kmistry/work/MCC9/searchingfornues/ntuple_files/neutrinoselection_filt_run3b_overlay.root --weight 3"
  ...
  ./nuexsec --run 3 --hist files/nuexsec_run3_merged.root --weight 3 &
  wait
