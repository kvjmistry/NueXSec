...
void HistogramHelper::InitHistograms(){
    ...
    if (_type == _util.k_mc){
        ...
        for (unsigned int i = 0; i < TH1D_true_hists.size(); i++){
            ...
            TH1D_true_hists.at(i).at(k_true_nue_e)     = new TH1D( Form("h_true_nue_e_%s_%s",     _util.type_prefix.at(_type).c_str(), cut_stage.c_str() ), ";True #nu_{e} + #bar{#nu}_{e} E [GeV]; Entries",    50, 0, 5);
            ...
            TH1D_true_hists.at(i).at(k_true_vtx_x)     = new TH1D( Form("h_true_vtx_x_%s_%s",     _util.type_prefix.at(_type).c_str(), cut_stage.c_str() ) ,";True #nu_{e} + #bar{#nu}_{e} Vtx x [cm]; Entries", 40, -10, 270);
            TH1D_true_hists.at(i).at(k_true_vtx_y)     = new TH1D( Form("h_true_vtx_y_%s_%s",     _util.type_prefix.at(_type).c_str(), cut_stage.c_str() ) ,";True #nu_{e} + #bar{#nu}_{e} Vtx y [cm]; Entries", 40, -120, 120);
            ...
            TH1D_true_hists.at(i).at(k_true_vtx_x_sce) = new TH1D( Form("h_true_vtx_x_sce_%s_%s", _util.type_prefix.at(_type).c_str(), cut_stage.c_str() ) ,";True #nu_{e} + #bar{#nu}_{e} Vtx x SCE Corr. [cm]; Entries", 40, -10, 270);
            TH1D_true_hists.at(i).at(k_true_vtx_y_sce) = new TH1D( Form("h_true_vtx_y_sce_%s_%s", _util.type_prefix.at(_type).c_str(), cut_stage.c_str() ) ,";True #nu_{e} + #bar{#nu}_{e} Vtx y SCE Corr. [cm]; Entries", 40, -120, 120);
            ...
            TH1D_true_hists.at(i).at(k_true_elec_gamma)  = new TH1D( Form("h_true_elec_gamma_%s_%s",   _util.type_prefix.at(_type).c_str(), cut_stage.c_str() ), ";True e#lower[-0.5]{-}/e^{+} NuMI #Phi [deg]; Entries",        18, -180, 180);
            ...
            TH2D_true_hists.at(i).at(k_true_elec_E_reco_elec_E_rebin) = new TH2D( Form("h_true_elec_E_reco_elec_E_rebin_%s_%s",         _util.type_prefix.at(_type).c_str(), cut_stage.c_str()),    ";True e#lower[-0.5]{-}/e^{+} Energy [GeV] ;Reco. e#lower[-0.5]{-}/e^{+} Energy [GeV]", _util.reco_shr_bins.size()-1, edges, _util.reco_shr_bins.size()-1, edges);
            ...
            TH2D_true_hists.at(i).at(k_elec_true_cosbeta_reco_cosbeta_rebin) = new TH2D( Form("h_elec_true_cosbeta_reco_cosbeta_rebin_%s_%s",         _util.type_prefix.at(_type).c_str(), cut_stage.c_str()),    ";True e#lower[-0.5]{-}/e^{+} cos#beta ;Reco. e#lower[-0.5]{-}/e^{+} cos#beta", _util.reco_shr_bins_cang.size()-1, edges_cbeta, _util.reco_shr_bins_cang.size()-1, edges_cbeta);

            TH2D_true_hists.at(i).at(k_true_elec_E_true_beta_rebin) = new TH2D( Form("h_true_elec_E_true_beta_rebin_%s_%s",         _util.type_prefix.at(_type).c_str(), cut_stage.c_str()),    ";True e#lower[-0.5]{-}/e^{+} Energy [GeV] ;True e#lower[-0.5]{-}/e^{+} cos#beta", _util.reco_shr_bins.size()-1, edges, _util.reco_shr_bins_cang.size()-1, edges_cbeta);
        }
    }
