...
double _Run3_Dirt_POT  = 6.43292e+20;      // Run 3 dirt POT
double _Run3_Data_POT  = 3.908e+19 ;       // Run 3 Data POT (tortgt) beam good and bad file
double _Run3_Data_trig = 845148.5;         // Run 3 data HW Triggers (EA9CNT)  beam good and bad file
