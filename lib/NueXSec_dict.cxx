...
#define R__DICTIONARY_FILENAME NueXSec_dict
...
namespace ROOT {
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::xsecAna::ParticleContainer*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::xsecAna::TPCObjectContainer*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<xsecAna::TPCObjectContainer>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<xsecAna::TPCObjectContainer>", -2, "vector", 216,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<xsecAna::TPCObjectContainer>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<xsecAna::ParticleContainer>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<xsecAna::ParticleContainer>", -2, "vector", 216,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<xsecAna::ParticleContainer>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace {
  void TriggerDictionaryInitialization_NueXSec_dict_Impl() {
...
"/cvmfs/larsoft.opensciencegrid.org/products/root/v6_12_06a/Linux64bit+3.10-2.17-e17-prof/include",
"/uboone/app/users/kmistry/MCC9_uboonecode_v08_00_00_33/srcs/ubana/ubana/NueXSec/lib/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "NueXSec_dict dictionary forward declarations' payload"
...
#line 1 "NueXSec_dict dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("NueXSec_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_NueXSec_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_NueXSec_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_NueXSec_dict() {
  TriggerDictionaryInitialization_NueXSec_dict_Impl();
}
