...
void xsecAna::TpcObjectMaker::produce(art::Event & e) {
    ...
    if(_cosmic_only == false && _is_mc == true) {
        ...
        for (lar_pandora::MCParticlesToPFParticles::const_iterator iter1 = matchedParticles.begin(), iterEnd1 = matchedParticles.end(); iter1 != iterEnd1; ++iter1) {
    ...
    for (size_t pfparticle_vector = 0; pfparticle_vector < pfp_v_v.size(); pfparticle_vector++) {
        ...
        // Add TPC Obj to vector and create associations
